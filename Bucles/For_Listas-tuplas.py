...
#Asi se pueden recorrer dos listas al mismo tiempo se puede con mas usando el mismo formato de abajo

#for animal, numero in zip(animales, numeros):
#    print(f"El animal es lista 1 es: {animal}")   
#    print(f"El numero en lista 2 es: {numero}")
...
#Y asi se puede recorrer en indices para las listas 0, 1 ,2 3,4 5, ....
#Recordad que len() nos da la longitud de la lista o cuantos elementos tiene

##NO ES UNA FORMA OPTIMA PARA RECORRER UNA LISTA (No funciona para recorrer un conjunto )
for i in range(len(numeros)):
    print(f"El numero en la posicion {i} es {numeros[i]}")
...
for num, i in enumerate(numeros):
    #Lo que esta pasando aqui es que en num se guarda el indice y en i se guarda el valor de la lista osea desempaquetamos la tupla
